<!-- stamp: 2026-08-26 systems:18 unmapped:0 unassigned-files:67 -->
...
| PowerupSystem | core, editor, ui | ExpoTheExplorer/Assets/Data/DataScripts/PowerupType.cs, ExpoTheExplorer/Assets/Scripts/Systems/PowerupSystem/ExpoTheExplorer.Systems.PowerupSystem.asmdef (+7) | - | - | - | OK |
...
| TicketSystem | core, ui | ExpoTheExplorer/Assets/Scripts/Core/Ticket.cs, ExpoTheExplorer/Assets/Scripts/Systems/TicketSystem/TicketSlotManager.cs (+9) | - | TicketCard, TicketCard Into, TicketCard UpDown | - | OK |
...
- 17 flagged codemap line(s) excluded from this table (STALE)
